	...
	, lumMultiplier(0.7)
{
	...
	app.variables.addVariable(TGen::Engine::Variable("r_postBloomBlurPasses", "2", "3", 0), TGen::Engine::AddOverrideDefaults | TGen::Engine::AddNoThrow);
	...
	app.variables.addVariable(TGen::Engine::Variable("r_postLuminanceMin", "0.4", "0.65", 0), TGen::Engine::AddOverrideDefaults | TGen::Engine::AddNoThrow);
	app.variables.addVariable(TGen::Engine::Variable("r_postLuminanceMultiplier", "0.7", "0.6", 0), TGen::Engine::AddOverrideDefaults | TGen::Engine::AddNoThrow);
	app.variables.addVariable(TGen::Engine::Variable("r_postLuminanceTrace", "true", "false", 0), TGen::Engine::AddOverrideDefaults | TGen::Engine::AddNoThrow);
